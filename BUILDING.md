...
CI packages `package/DeathNotices.dll`; it does not compile the mod or need game
...
3. Commit and push the source, metadata and refreshed `package/DeathNotices.dll`.
